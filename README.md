[![Typing SVG](https://readme-typing-svg.demolab.com/?typeSpeed=100&pause=100&lines=Hi%2C+I%27m+Bader!;I+break+things+from+frontend+to+backend;It+worked+locally+(the+cloud+disagrees);Segfaults+keep+me+humble)](https://git.io/typing-svg)
